...
- كل الشاشات مبنية بنفس هوية النموذج الأولي HTML (نفس CSS حرفياً)، ومُختبرة فعلياً بالمتصفح ضد الـ API الحقيقي.

## الخطوة التالية
حسب خطة المواصفات: تطبيق المستهلك (React Native/Expo) — تسجيل + تصفح + عرض ملف محل كنسخة أولى، ثم الشات المباشر (Socket.io)، ثم الحجز/الشراء/الدفع الفعلي.
