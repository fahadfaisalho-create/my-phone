...
const dict = {
  ar: {
    ...
    stores: {
      ...
      licenseNoLabel: 'رقم رخصة العمل الحر',
      ...
      resetPasswordHeading: 'إعادة تعيين كلمة سر صاحب المحل',
      resetPasswordNote: 'يُستخدم لما التاجر ينسى كلمة سره ويتواصل معك مباشرة (بدون بريد/SMS).',
      newPasswordLabel: 'كلمة السر الجديدة',
      resetPasswordSubmit: 'تحديث كلمة السر',
      resetPasswordSuccess: 'تم تحديث كلمة السر بنجاح',
      resetPasswordError: 'تعذّر تحديث كلمة السر',
    },
    consumers: {
      heading: 'المستهلكين',
      searchPlaceholder: 'ابحث بالاسم أو رقم الجوال...',
      loadError: 'تعذّر تحميل المستهلكين',
      empty: 'لا يوجد مستهلكين',
      joinedAt: 'تاريخ التسجيل',
      ordersCount: 'عدد الطلبات',
      bookingsCount: 'عدد الحجوزات',
      suspended: 'موقوف',
      active: 'نشط',
      suspendAction: 'إيقاف الحساب',
      reactivateAction: 'إعادة تفعيل الحساب',
      suspendConfirm: (name: string) => `إيقاف حساب "${name}"؟ لن يقدر يسجّل الدخول بعدها.`,
      selectPrompt: 'اختر مستهلكاً من القائمة',
      resetPasswordHeading: 'إعادة تعيين كلمة السر',
      resetPasswordNote: 'يُستخدم لما المستهلك ينسى كلمة سره ويتواصل معك مباشرة (بدون بريد/SMS).',
      newPasswordLabel: 'كلمة السر الجديدة',
      resetPasswordSubmit: 'تحديث كلمة السر',
      resetPasswordSuccess: 'تم تحديث كلمة السر بنجاح',
      resetPasswordError: 'تعذّر تحديث كلمة السر',
      prevPage: 'السابق',
      nextPage: 'التالي',
      pageLabel: (page: string, total: string) => `صفحة ${page} من ${total}`,
    },
    technicians: {
      tabPending: 'قيد المراجعة',
      tabApproved: 'معتمد',
      tabRejected: 'مرفوض',
      heading: 'طلبات انضمام الفنيين',
      loadError: 'تعذّر تحميل طلبات الفنيين',
      empty: 'لا يوجد فنيون بهذه الحالة',
      nationalityLabel: 'الجنسية',
      experienceLabel: 'سنوات الخبرة',
      licenseNoLabel: 'رقم رخصة العمل الحر',
      licenseFile: 'ملف رخصة العمل الحر',
      notAttached: 'غير مرفق',
      storeLabel: 'مقدَّم من محل',
      individualLabel: 'فني مستقل',
      companyLabel: 'محل',
      rejectionReasonLabel: 'سبب الرفض',
      approveRequest: 'قبول',
      rejectRequest: 'رفض',
      ...
      approveError: 'تعذّر قبول الطلب',
      rejectError: 'تعذّر رفض الطلب',
      verifiedAtLabel: 'تاريخ الاعتماد',
      photo: 'صورة الفني',
    },
    orders: {
  ...
  en: {
    ...
    nav: {
      ...
      technicians: 'Technician Requests',
      consumers: 'Consumers',
    ...
    stores: {
      ...
      licenseNoLabel: 'Freelance license number',
      ...
      resetPasswordHeading: "Reset owner's password",
      resetPasswordNote: 'Use this when the merchant forgets their password and contacts you directly (no email/SMS needed).',
    ...
    consumers: {
      ...
      loadError: 'Could not load consumers',
      empty: 'No consumers found',
      joinedAt: 'Joined on',
      ordersCount: 'Orders',
      ...
      suspendConfirm: (name: string) => `Suspend "${name}"'s account? They will no longer be able to sign in.`,
      selectPrompt: 'Select a consumer from the list',
      resetPasswordHeading: 'Reset password',
      resetPasswordNote: 'Use this when a consumer forgets their password and contacts you directly (no email/SMS needed).',
      newPasswordLabel: 'New password',
      resetPasswordSubmit: 'Update password',
      resetPasswordSuccess: 'Password updated successfully',
      resetPasswordError: 'Could not update the password',
      prevPage: 'Previous',
      nextPage: 'Next',
      pageLabel: (page: string, total: string) => `Page ${page} of ${total}`,
    },
    technicians: {
      tabPending: 'Pending',
      tabApproved: 'Approved',
      tabRejected: 'Rejected',
      heading: 'Technician Join Requests',
      loadError: 'Could not load technician requests',
      empty: 'No technicians in this state',
      nationalityLabel: 'Nationality',
      experienceLabel: 'Years of experience',
      licenseNoLabel: 'Freelance license number',
      licenseFile: 'Freelance license file',
      notAttached: 'Not attached',
      storeLabel: 'Submitted by store',
      individualLabel: 'Independent technician',
      companyLabel: 'Store',
      rejectionReasonLabel: 'Rejection reason',
