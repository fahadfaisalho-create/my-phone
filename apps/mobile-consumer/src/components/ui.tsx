...
import { Animated, ActivityIndicator, Platform, Pressable, StyleSheet, Text, View } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  primaryBtn: {
    ...
    ...(Platform.OS === 'web'
      ? ({ boxShadow: '0 6px 16px rgba(79,70,229,0.25)' } as any)
      : {
  ...
  linkText: { color: colors.indigoDeep, fontFamily: fonts.bodyMedium, fontSize: 13, textDecorationLine: 'underline' },
