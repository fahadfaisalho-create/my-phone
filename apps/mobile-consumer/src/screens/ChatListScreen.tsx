...
const styles = StyleSheet.create({
  ...
  avatarFallback: { backgroundColor: colors.tealBg, alignItems: 'center', justifyContent: 'center' },
  avatarFallbackText: { fontFamily: fonts.headingExtra, fontSize: 18, color: colors.tealDark },
